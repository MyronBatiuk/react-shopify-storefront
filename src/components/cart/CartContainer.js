    ...
    return (
      <div className={`Cart ${cartStatus ? 'Cart--open' : ''}`}>
        <header className="Cart__header">
          <img onClick={this.props.closeCart} className="arrow-left" src={ArrowLeft} alt=""/>
          <h5 onClick={this.props.closeCart}>Continue Shopping</h5>
        ...
        <footer className="Cart__footer">
          <Link className="Cart__footer-link" to="/pages/shipping-policy" onClick={this.props.closeCart}>Shipping policy</Link>
          <span className="Cart__footer-devider">|</span>
          <Link className="Cart__footer-link" to="/pages/return-policy" onClick={this.props.closeCart}>Return policy</Link>
        </footer>
      </div>
    )
  }
